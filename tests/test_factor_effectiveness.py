...
class FactorEffectivenessTests(unittest.TestCase):
    def test_latest_audited_study_drives_all_four_quadrants(self):
        ...
        self.assertEqual(result["coverage"]["factors"], 39)
        self.assertEqual(result["coverage"]["audited_events"], 62170)
        self.assertEqual(result["quadrant_counts"], {"in_use": 7, "watch": 15, "paused": 9, "retire": 8})
        ...
        self.assertEqual(factors["structure.triple_bottom_pullback"]["quadrant"], "watch")
        self.assertEqual(factors["structure.double_bottom_neckline_retest"]["quadrant"], "watch")
