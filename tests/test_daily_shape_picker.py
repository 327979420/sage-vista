...
class PickerTests(unittest.TestCase):
    ...
    def test_membership_stale_data_and_hash_binding(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            from services.scanner.daily_shape_public import project
            live=build_preview(cache,common,as_of=as_of,include_legacy=False)
            self.assertEqual(project(report),project(live))
