...
- UI：v5.7。
- 因子库：0.8.0，共 37 项。
- 当前夜间新批次模型：`unified-v2-macd-trigger-1.2.0`；因子注册表代码版本 `0.8.0`。
- 数据审计：日期一致 `true`；未来数据 `false`。

## 历史回测断点

- 已保存：2026-04-27 至 2026-08-27，共 86 个交易日。
- 最近成功周：2026-04-27 至 2026-04-30，共 4 个交易日。
- 下一批：2026-04-20 至 2026-04-26。
- 夜间续跑：已开启；21:30 AEST / 22:30 AEDT；成功后才移动断点，失败重试同一周。
- 旧批次冻结原规则版本；新规则只用于后续尚未运行批次。
- 回测状态更新时间：2026-08-28T11:44:03Z。

## 实验

- 总数 20；已完成 18；待运行 / 进行中 2。
...
来源时间：生产数据更新 2026-08-28T08:07:48.668329+00:00；实验目录生成 2026-08-28T19:12:47+10:00。
