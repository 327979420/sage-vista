...
- 网站部署提交编号：671af459e567137d438bf11ccf44b18fd5e19088
- 夜间最近已保存批次版本：unified-v2-macd-trigger-1.4.0
- 夜间批次编号：2025-12-08_to_2025-12-14
- 夜间运行提交编号：未知
- 版本号相同不能自动判断代码相同。
...
- 已保存：2025-12-08 至 2026-09-25，共 196 个交易日。
- 最近成功周：2025-12-08 至 2025-12-14，共 5 个交易日。
- 下一批：2025-12-01 至 2025-12-07。
- 夜间续跑：已开启；21:30 AEST / 22:30 AEDT；成功后才移动断点，失败重试同一周。
- 旧批次冻结原规则版本；新规则只用于后续尚未运行批次。
- 回测状态更新时间：2026-09-26T15:07:44Z。
