...
- 最新完整美股收盘：2026-09-25；生产状态尚未核验或日期不一致。
- UI：v6.1。
- 因子库：0.10.0，共 39 项。
...
- 网站部署提交编号：4b5301747c70ade99b933040d050f1b0ca53a39b
- 夜间最近已保存批次版本：unified-v2-macd-trigger-1.4.0
- 夜间批次编号：2025-12-15_to_2025-12-21
- 夜间运行提交编号：未知
- 版本号相同不能自动判断代码相同。
...
- 已保存：2025-12-15 至 2026-09-24，共 190 个交易日。
- 最近成功周：2025-12-15 至 2025-12-21，共 5 个交易日。
- 下一批：2025-12-08 至 2025-12-14。
- 夜间续跑：已开启；21:30 AEST / 22:30 AEDT；成功后才移动断点，失败重试同一周。
- 旧批次冻结原规则版本；新规则只用于后续尚未运行批次。
- 回测状态更新时间：2026-09-25T15:57:10Z。
...
来源时间：生产数据更新 2026-09-25T23:56:58.108191+00:00；实验目录生成 2026-09-13T15:49:44Z。
