...
CR056候选政策2.0.0先许可，再以固定白名单和周期满分归一后按月/周/日3:2:1加权；日满分5、周2、月3.25。唯一参数及内容指纹见services/contracts/cr056_policy.py，唯一评分见services/ranking/cr056.py。缺失不缩减分母；覆盖不足80%不可评分，不完整覆盖不发高分警报。参数尚未验证收益；旧1.x结果留档。 用户已授权真实重排及现有页面更新；本次发布9月4日快照，新榜自动日更尚未接通，页面必须如实显示独立日期及落后提示。原批准/预登记见提交acfc061，交付证据集中见[CR056](../CHANGE_REQUESTS_ZH.md)。后续先日更续跑，再大盘行业、回测。
