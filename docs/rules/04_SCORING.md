...
CR056后台候选政策独立2.0.0：先许可，固定白名单/周期满分归一后月周日3/2/1；日K5、周K2、月K3.25，组/家族封顶与q/coverage按已审完整卡。参数不是验证收益；旧1.x公式不改，不激活线上。 唯一精确政策见[CR056设计](../MONTH_WEEK_DAY_REQUIREMENT_CORRECTION_ZH.md)；用户批准先真实后台榜、后大盘行业、再回测。无线上新政策授权。
