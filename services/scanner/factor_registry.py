...
FACTORS = (
    ...
    factor("structure.engulfing_bullish_follow_through", "看涨吞没后K线跟随", "the immediately following completed daily candle closes bullish after a registered support bullish engulfing", "price_structure", status="candidate", score_mode="observational", weight=1, redundancy="engulfing_follow_through", explanation="支撑位看涨吞没后的下一根完整日K线继续收阳，确认短期上涨动能；必须依赖前一日吞没，不能独立触发。", depends_on=("structure.support_bullish_engulfing",), window=5, tier="core", experimental_weight=1),
