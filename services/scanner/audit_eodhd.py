"""Audit EODHD universe and price integrity for reproducible research.

Input: provider symbol lists, daily prices, splits and dividends.
Output: a versioned research report under ``research/``; never a website feed.
"""
import json,pathlib
...
def run(out="research/backtest/output/legacy-foundation/data-audit.json"):
    ...
    path.write_text(json.dumps(report,indent=2,default=dict));return report
