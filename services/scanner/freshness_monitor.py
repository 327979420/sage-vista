...
def evaluate(provider_latest,status):
 dates={"source":status.get("source_latest_complete_date"),"tracker":status.get("tracker_as_of"),"radar":status.get("radar_as_of"),"factor_snapshot":status.get("factor_snapshot_as_of")}
