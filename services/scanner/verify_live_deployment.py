...
def verify_once(base,expected):
 ...
 status=fetch(base,"update-status.json",expected,attempts=1);tracker=fetch(base,"resonance-tracker.json",expected,attempts=1);snapshot=fetch(base,"daily-factor-snapshot.json",expected,attempts=1);radar=fetch(base,"rare-opportunity-radar.json",expected,attempts=1);industry=fetch(base,"industry-radar.json",expected,attempts=1);market=fetch(base,"market-etf-watch.json",expected,attempts=1);history=fetch(base,"signal-history.json",expected,attempts=1)
