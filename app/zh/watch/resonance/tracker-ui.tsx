...
export type Item={symbol:string;price:number;macd_score:number;rsi_score:number;macd_resonance:number;rsi_resonance:number;chain_score:number;chain_reason:string;macd_gate_reason:string;combined_score:number;rsi_divergence_frames:string[];volume:{label:string;score:number;ratio:number|null;near_bottom:boolean;direction:string};frames:Record<string,Frame>};
...
export const modules=[
 ["总览","/zh/watch/resonance"],["双指标确认","/zh/watch/resonance/confluence"],["MACD","/zh/watch/resonance/macd"],["RSI","/zh/watch/resonance/rsi"],["成交量","/zh/watch/resonance/volume"],["需求取舍","/zh/watch/resonance/requirements"],
] as const;
