...
const reasons:Record<string,string>={
 ...
 positive_histogram_supported:"正柱保持或增强",negative_histogram_improving:"负柱连续改善",positive_histogram_shrinking:"正柱缩短：周分按75%计入",below_observed_high_proves_below_all_time_high:"远离已观测高点，采用保守高位检查",monthly_high_zone_clear:"月线高位检查通过",pullback_60d:"已有足够回调",structure_intact:"原支撑结构保持",deep_sweep_reclaimed:"深度回撤后已重新收复关键支撑",deep_pullback_warning:"回调较深，但尚未触发结构破坏",uptrend_pullback:"长期上涨后的回调",long_base_pullback:"长期筑底背景中的回调",
};
