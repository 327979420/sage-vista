...
const stageTone:Record<string,string>={entry_ready:"ready",waiting_breakout:"waiting",bottom_confirmed:"forming",pullback_forming:"forming",launched:"launched",target_reached:"reached",invalidated:"invalid"};
...
export default function FavoritePatternPage(){
 ...
 return <TrackerShell active="我最喜欢形态" title="我最喜欢形态" subtitle="每天追踪你真正愿意做的日线共振，而不是再堆一套评分。">
  <div className="favoritePage">
   ...
   {data?<>
    <section className="favoriteMetrics"><article><small>数据日</small><b>{data.as_of}</b><span>{data.pattern_version}</span></article><article><small>入场就绪</small><b>{data.summary.entry_ready}</b><span>完整收盘已突破</span></article><article><small>等待突破</small><b>{data.summary.waiting_breakout}</b><span>只观察，不行动</span></article><article><small>回调／双底形成中</small><b>{data.summary.forming}</b><span>提前放进视野</span></article><article><small>当前观察表</small><b>{data.summary.watchlist}</b><span>全市场同日扫描</span></article></section>
