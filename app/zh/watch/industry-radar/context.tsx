...
export type Theme={theme_id:string;name:string;reference_etf:string|null;source_url:string|null;membership_as_of:string|null;membership_source_url:string|null;members:string[];manual:boolean};
export type Context={as_of:string;themes:Theme[];funds:Record<string,Fund>;ticker_themes:Record<string,string[]>;classifications:Record<string,{sector:string|null;industry:string|null}>;classification_as_of:string|null;coverage:{themes:number;reference_etfs:number;available_etfs:number;dated_membership_themes:number}};
